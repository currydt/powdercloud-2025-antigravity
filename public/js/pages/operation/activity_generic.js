function Controller() {
    ...
    this.mainDetail = new pc.custom.GenericTaskForm({
        itemId: 'mainDetail'
    });
...
Controller.prototype.init = function() {
    ...
    //this.mainDetail.on('continue', this.continueTask, this); NO Continue
...
Ext.onReady(function() {
    ...
    var linkUtil = new LinkUtil({form: controller,
            entity: 'Activity',
            record: new ActivityVO(),
            fn: function(record, args){
                    args.form.editActivity(record);
            }
    });
});
