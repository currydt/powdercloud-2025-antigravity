...
Ext.onReady(function(){
		...
		items:[
			...
			{	// Scope
				...
				items: [
					{
						xtype:'container',
						html:'<p> This section allows you to specify the observation date and time, and its key location. Locations are limited to type Region, and Forecast Zone.</p>'
					},
					{
			...
			{	// Details
				...
				items: [
					{
						xtype:'container',
						html:'<p> This section allows you to write a brief narrative describing current snow layers. </p>'
					},
					{
						fieldLabel: 'Notes',
   ...
   operationTerrainUtil = new OperationTerrainUtil(null,
            ...
            handler: function(button){
                ...
                fs.getForm().submit({
                    ...
                    params:{
                        ...
                        type: 'persistentlayernarrative__ObservationType__lookup'
                    },
    ...
    tableStore = new Ext.data.Store({
        ...
        baseParams:{
            entity: 'PersistentLayer',
            type__ObservationType__lookup: 'persistentlayernarrative',
            start:0,
            limit:PAGING_LIMIT
        },
        proxy: new Ext.data.ScriptTagProxy({
    ...
    grid = new Ext.grid.GridPanel({
        ...
        tbar: new Ext.Toolbar({
            items: ['->',{
                    ...
                    scope: this,
                    handler: function() {
                        var record = new PersistentLayerVO({
