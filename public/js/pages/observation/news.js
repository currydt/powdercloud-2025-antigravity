...
Ext.onReady(function(){
		...
		items:[
			...
			{	// Operation
				...
				items: [
					...
					// Notable
					{
						fieldLabel: pcLocal.getText('Field.Observation.TH.notable'),
						name: 'notable',
						xtype: 'checkbox',
						width: 100
					},
			...
			{	// Scope
				...
				items: [
					{
						xtype:'container',
						html:'<p> This section allows you to specify the observation date and time, and its key location. Locations are limited to type Region. </p>'
					},
					{
			...
			{	// Details
				...
				items: [
					{
						xtype:'container',
						html:'<p> This section allows you to write a brief narrative, using basic styles. </p>'
					},
					{
						fieldLabel: 'Notes',
				...
				handler: function(button){
					...
					fs.getForm().submit({
						...
						params:{
							...
							type: 'news__ObservationType__lookup'
						},
	...
	tableStore = new Ext.data.Store({
		reader: new Ext.data.JsonReader({ totalProperty: 'totalCount', root: 'rows' }, NewsVO),
		remoteSort: true,
		baseParams:{
			entity: 'News',
