	...
	border: false,
		...
		button.disable();
                ...
                fs.getForm().submit({
                    ...
                    params:{
                        entity: 'Sighting',
                        form: 'pc.forms.observation.SightingNarrativeObservationForm',
			type: 'sightingnarrative__ObservationType__lookup'
                    },
    ...
    */
    ...
    tableStore = new Ext.data.Store({
        ...
        baseParams:{
            ...
            type__ObservationType__lookup: 'sightingnarrative',
	    start:0,
            limit:PAGING_LIMIT
        },
        proxy: new Ext.data.ScriptTagProxy({
