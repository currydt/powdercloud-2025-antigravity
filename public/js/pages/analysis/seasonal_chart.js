...
Ext.onReady(function(){
    ...
    */
	...
	tbar: new Ext.Toolbar({
            items: [
                {
                    xtype: 'textfield',
                    searchBy: 'terrain__Terrain__lookup',
		    store:masterStore,
		    width: 150,
                    emptyText: 'Search by exact location',
		    listeners: {
			keyup: {
			    scope:this,
    ...
    */
	...
	items:[
		...
		items:[{
		    xtype:'container',
		    html:'<p>The following section displays the various observational data, summarized within a standardized seasonal chart.</p>'
		},
		    new Ext.Container({
		...
		items:[{
		    xtype:'container',
		    html:'<p>The following table displays the various observations in textual format. You can select an individual column to resize it; change its position,  or to hide and show the column. You can sort these data by date and time in ascending or descending order.</p>'
		},
		    grid
		]
	    }),
		...
		items:[{
		    xtype:'container',
		    html:'<p>The following map displays the location of the weather station, and region utilized in the observations. You can mange the view by using the toolbar (for example, Map or Earth). You can alter the scale using the vertical scale, and while in Earth mode you can alter the prespecitve with the upper left control.</p>'
		},
		    mapOverlay
		],
		listeners:{
