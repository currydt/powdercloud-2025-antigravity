...
export class PowdercloudObservationTypeListGrid extends LitElement {
    static properties = {
        _data: { state: true },
        _isMock: { state: true }
    };
    ...
    render() {
        ...
        return html`
            ...
            <powdercloud-dashboard-grid .columns="${columns}" .data="${this._data}"></powdercloud-dashboard-grid>
        `;
    }
}

customElements.define('powdercloud-observation-type-list-grid', PowdercloudObservationTypeListGrid);
