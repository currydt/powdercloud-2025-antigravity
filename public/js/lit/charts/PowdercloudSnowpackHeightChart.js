...
export class PowdercloudSnowpackHeightChart extends DashboardChart {
    constructor() {
        super();
        this.title = "HS & HN24";
        this.type = "column";
...
customElements.define('powdercloud-snowpack-height-chart', PowdercloudSnowpackHeightChart);
