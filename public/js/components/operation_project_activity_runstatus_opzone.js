...
pc.custom.ActivityRunStatusOpZoneForm = Ext.extend(Ext.Panel, {
    border: false,
    defaults: {
        anchor: '0',
        border: false
    ...
    initComponent: function() {
        ...
        this.runStore =  Ext.StoreMgr.lookup('locationOperatingZones');
        ...
        */
        ...
        this.mainForm = new Ext.FormPanel({
            ...
            params: {
                ...
                type: 'runstatusOpZone__ActivityType__lookup'
            },
            waitMsgTarget: true,
        ...
        this.runTableContainer = new Ext.form.FieldSet({
            title: 'Operating Zone Table',
            collapsible: false,
            collapsed: false,
            items: [{
                xtype:'container',
                html:'<p>Use the table below to enter Zone data.</p>'
            },
                this.runTable
            ]
        });
        ...
        pc.custom.ActivityRunStatusOpZoneForm.superclass.initComponent.call(this);
    ...
    onRunStatusOrRunsLoad: function(store, records, options){
        if(store.storeId == 'locationOperatingZones'){
...
Ext.reg('activityrunstatusopzoneform', pc.custom.ActivityRunStatusOpZoneForm);
