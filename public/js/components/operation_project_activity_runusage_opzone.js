...
pc.custom.ActivityRunUsageOpZoneForm = Ext.extend(Ext.Panel, {
    border: false,
    defaults: {
        anchor: '0',
        border: false
        ...
        */
        ...
        this.mainForm = new Ext.FormPanel({
            ...
            params: {
                ...
                type: 'runusageOpZone__ActivityType__lookup'
            },
            waitMsgTarget: true,
        ...
        pc.custom.ActivityRunUsageOpZoneForm.superclass.initComponent.call(this);
...
Ext.reg('activityrunusageopzoneform', pc.custom.ActivityRunUsageOpZoneForm);
