...
pc.custom.RingSlicesCmp = Ext.extend(Ext.form.Field, {
    // private
    actionMode: 'wrap',
    ...
    onRender : function(ct, position){
        ...
        pc.custom.RingSlicesCmp.superclass.onRender.call(this, ct, position);
	...
	this.svgWidth = 75;
	this.svgHeight = 75;
	this.svgCmp = new PowdercloudSvgRing(this.svgWidth, this.svgHeight, 3, "#FFFFFF", "#000000");
        pc.custom.RingSlicesCmp.superclass.initComponent.call(this);
    },
    /**
	...
	this.value = v;
	this.svgCmp.drawRings(this.svg, v);
    },
    /**
	...
	$('#'+this.id).val(this.svgCmp.getSelectedRings().join());
	return this.svgCmp.getSelectedRings().join();
    },
    getRawValue: function(){
	return this.getValue();
    }
});
Ext.reg('ringslicescmp', pc.custom.RingSlicesCmp);