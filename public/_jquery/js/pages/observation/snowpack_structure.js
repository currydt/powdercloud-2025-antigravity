...
Ext.onReady(function(){
		...
		items:[
			...
			{	// Details
				...
				items: [
					{
						xtype:'container',
						html:'<p> This section allows you to write a brief narrative. It generally contains snowpack structure and tests. </p>'
					},
                                        {
                                                fieldLabel: 'Notes',
   ...
   operationTerrainUtil = new OperationTerrainUtil(null,
    ...
    tableStore = new Ext.data.Store({
        reader: new Ext.data.JsonReader({totalProperty: 'totalCount', root: 'rows'}, SnowpackStructureVO),
        remoteSort: true,
        baseParams:{
            entity: 'SnowpackStructure',
    ...
    grid = new Ext.grid.GridPanel({
        ...
        tbar: new Ext.Toolbar({
            items: ['->',{
                    ...
                    scope: this,
                    handler: function() {
                        var record = new SnowpackStructureVO({   operation: operation.key,
    ...
    */
    var linkUtil = new LinkUtil({form: fs,
                                entity: 'SnowpackStructure',
                                record: new SnowpackStructureVO(),
                                fn: function(records){
                                    operationTerrainUtil.reset();
                                    fs.getForm().loadRecord(records);
                                    operationTerrainUtil.loadLocation(records.data.operation);
