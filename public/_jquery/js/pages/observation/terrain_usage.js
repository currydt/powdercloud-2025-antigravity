...
Ext.onReady(function(){
		...
		items:[
			...
			{	// Details
				...
				items: [
					{
						xtype:'container',
						html:'<p> This section allows you to write a brief terrain usage narrative. It generally contains usage and associated information. </p>'
					},
                                        {
                                                fieldLabel: 'Notes',
   ...
   operationTerrainUtil = new OperationTerrainUtil(null,
    ...
    tableStore = new Ext.data.Store({
        reader: new Ext.data.JsonReader({totalProperty: 'totalCount', root: 'rows'}, TerrainUsageVO),
        remoteSort: true,
        baseParams:{
            entity: 'TerrainUsage',
    ...
    grid = new Ext.grid.GridPanel({
        ...
        tbar: new Ext.Toolbar({
            items: ['->',{
                    ...
                    scope: this,
                    handler: function() {
                        var record = new TerrainUsageVO({   operation: operation.key,
