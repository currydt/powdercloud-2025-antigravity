...
weatherGrid, avalancheGrid, snowpackStructureGrid, snowprofileGrid, layersGrid, concernsGrid, dangerGrid, stabilityGrid, newsGrid,
weatherStore, avalacheStore, snowpackStructureStore, snowprofileStore, layersStore, concernsStore, dangerStore, stabilityStore, newsStore,
...
Ext.onReady(function(){
    ...
    */
    ...
    avalancheStore = new ModeDaterangeFilterStore({
        baseParams:{
            entity: 'Avalanche',
	    type__ObservationType__lookup: 'avalancheeventmultiple,avalanchenarrative,avalancheeventstandard',
	    '__community_mode':'c',
	    sort: 'date_time_start',
	    dir: 'DESC',
            'date_time_start__range': filterCmp.start_date.format('Y-m-d 00:00')+'/'+filterCmp.end_date.format('Y-m-d 23:59')
...
//            },
    ...
    */
	...
	items:[
            {
                xtype:'container',
                html:'<p>The following text displays the current News, Avalanche Observation Narratives and Events, Concerns, Danger and Stability Ratings, Snowpack Structure and Snowpack Profiles, and Weather.</p>'
            },
