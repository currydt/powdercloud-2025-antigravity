...
Ext.onReady(function(){
    ...
    */
	...
	items:[
		...
		items:[{
		    xtype:'container',
		    html:'<p>The following table displays the sighting fields in textual format. You can select an individual column to resize it; change its position,  or to hide and show the column. You can sort by date and time in ascending or descending order.</p>'
		    },
		    grid
		]
	    }),
