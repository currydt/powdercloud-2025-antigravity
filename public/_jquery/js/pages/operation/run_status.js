function Controller() {
    ...
    this.mainDetail = new pc.custom.ActivityRunStatusForm({
        itemId: 'mainDetail'
    });
...
Controller.prototype.init = function() {
    this.mainList.getSelectionModel().on('selectionchange', this.onSelectChange, this);
    this.mainList.on('add', this.addActivity, this);
    this.mainList.on('print', this.printActivity, this);
...
Controller.prototype.onSelectChange = function(selModel) {
    Ext.getCmp('PrintBtnRunUsage').setDisabled(selModel.selections.length === 0);
}
Controller.prototype.printActivity = function() {
    var record = this.mainList.getSelectionModel().getSelected();
...
pc.custom.ActivityList = Ext.extend(Ext.grid.GridPanel, {
    ...
    initComponent: function(){
        ...
        var tableStore = new Ext.data.Store({
            ...
            baseParams:{
                entity: 'Activity',
                type__ActivityType__lookup: 'runstatus',
                start:0,
                limit:PAGING_LIMIT
            },
            //autoLoad: true,
